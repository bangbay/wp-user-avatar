...
class WP_User_Avatar_Admin {
  function __construct(){
    global $show_avatars, $wpua_allow_upload;
    // Admin menu settings
  ...
  function wpua_admin(){
    add_menu_page(__('WP User Avatar', 'wp-user-avatar'), __('WP User Avatar', 'wp-user-avatar'), 'manage_options', 'wp-user-avatar', array($this, 'wpua_media_page'), WPUA_URL.'images/wpua-icon.png');
    add_submenu_page('wp-user-avatar', __('Library'), __('Library'), 'manage_options', 'wp-user-avatar', array($this, 'wpua_media_page'));
    add_submenu_page('wp-user-avatar', __('Settings'), __('Settings'), 'manage_options', 'wp-user-avatar-settings', array($this, 'wpua_options_page'));
    add_action('admin_init', array($this, 'wpua_admin_settings'));
  }

  // Media page
  function wpua_media_page(){
  ...
  // Get list table
  function _wpua_get_list_table($class, $args = array()){
